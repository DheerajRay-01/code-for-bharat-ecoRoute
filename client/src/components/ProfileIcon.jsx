...
function ProfileIcon({user}) {
  ...
  const avatar =  `https://avatar.iran.liara.run/username?username=${user?.fullName.replace(" ","+")}`
...
const handleLogout = () => {
  ...
  <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 shadow-sm right-1">
